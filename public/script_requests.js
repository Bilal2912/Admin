...
ele_yes.forEach(e=>{
    e.addEventListener('click',()=>{
        ...
        setTimeout(() => {
            ...
            window.open(`mailto:bilalsani1011@gmail.com?subject=Order Approval&body=Congratulations, Your Order has been Approved`); 
        }, 1500);
    })
})
let con = true;
document.getElementById('theemail').addEventListener('click',()=>{
    ...
    if(content!=''){
        alert("You will be redirected to your email client website");
        window.open(`mailto:bilalsani1011@gmail.com?subject=Order Approval&body=${content}`); 
